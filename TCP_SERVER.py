...
# Once finished it lets sends a message to the user letting them know that the data was received and saved.
def handler_client(client_socket):
    ...
    client_socket.send(b"Username and Password Saved!")
    client_socket.close()
